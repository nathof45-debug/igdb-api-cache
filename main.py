...
if res.status_code == 200:
    ...
    for g in cleaned:
        # On définit ce qui est une "vraie" sortie
        VALID_STATUSES = {6, 34, 3} 
        ...
        has_precise_recent_release = any(
            ...
            rd.get("status") in VALID_STATUSES and
            rd.get("date") and 
...
if res_prims.status_code == 200:
    ...
    if ids_str:
        ...
        if res_games.status_code == 200:
            ...
            cleaned = [g for g in cleaned if g.get("status") not in {1, 2}] # Filtrage sur le statut global du jeu
